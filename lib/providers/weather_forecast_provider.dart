...
class ForecastTileProvider implements TileProvider {
  ...
  Future<Tile> getTile(int x, int y, int? zoom) async {
    ...
    try {
      ...
      String apiKey = "9de243494c0b295cca9337e1e96b00e2"; // REPLACE IT HERE
      final url =
          "http://maps.openweathermap.org/maps/2.0/weather/$mapType/$zoom/$x/$y?date=$date&opacity=$opacity&fill_bound=true&appid=$apiKey";
